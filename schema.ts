...
/**All Root resolvers*/export type Root={"getUserRoleEnumPaginator":{"Type":(UserRole);"Args":(undefined);};"getCurrentUser":{"Type":(User);"Args":(undefined);};"syncCurrentUser":{"Type":(User);"Args":(undefined);};"getUser":{"Type":(User);"Args":(InputTypes['user']);};"getUserPaginator":{"Type":(UserPaginator);"Args":(InputTypes['userPaginatorInput']);};"getUserStats":{"Type":(StatsResponse);"Args":(InputTypes['userStatsInput']);};"deleteUser":{"Type":(User);"Args":(InputTypes['user']);};"createUser":{"Type":(User);"Args":(InputTypes['createUser']);};"updateUser":{"Type":(User);"Args":(InputTypes['updateUser']);};"getApiKey":{"Type":(ApiKey);"Args":(InputTypes['apiKey']);};"getApiKeyPaginator":{"Type":(ApiKeyPaginator);"Args":(InputTypes['apiKeyPaginatorInput']);};"getApiKeyStats":{"Type":(StatsResponse);"Args":(InputTypes['apiKeyStatsInput']);};"deleteApiKey":{"Type":(ApiKey);"Args":(InputTypes['apiKey']);};"createApiKey":{"Type":(ApiKey);"Args":(InputTypes['createApiKey']);};"updateApiKey":{"Type":(ApiKey);"Args":(InputTypes['updateApiKey']);};"getRepositoryReleases":{"Type":(Scalars['unknown'])[];"Args":(InputTypes['getRepositoryReleases']);};"getRepositoryLatestVersion":{"Type":(Scalars['unknown'])|null;"Args":(undefined);};"getFile":{"Type":(File);"Args":(InputTypes['file']);};"getFilePaginator":{"Type":(FilePaginator);"Args":(InputTypes['filePaginatorInput']);};"getFileStats":{"Type":(StatsResponse);"Args":(InputTypes['fileStatsInput']);};"deleteFile":{"Type":(File);"Args":(InputTypes['file']);};"createFile":{"Type":(File);"Args":(InputTypes['createFile']);};"updateFile":{"Type":(File);"Args":(InputTypes['updateFile']);};"executeAdminFunction":{"Type":(Scalars['unknown']);"Args":(Scalars['string']);};"executeGoogleApiRequest":{"Type":(Scalars['unknown'])|null;"Args":(InputTypes['executeGoogleApiRequestInput']);};"getUserUserFollowLink":{"Type":(UserUserFollowLink);"Args":(InputTypes['userUserFollowLink']);};"getUserUserFollowLinkPaginator":{"Type":(UserUserFollowLinkPaginator);"Args":(InputTypes['userUserFollowLinkPaginatorInput']);};"getUserUserFollowLinkStats":{"Type":(StatsResponse);"Args":(InputTypes['userUserFollowLinkStatsInput']);};"deleteUserUserFollowLink":{"Type":(UserUserFollowLink);"Args":(InputTypes['userUserFollowLink']);};"createUserUserFollowLink":{"Type":(UserUserFollowLink);"Args":(InputTypes['createUserUserFollowLink']);};"updateUserUserFollowLink":{"Type":(UserUserFollowLink);"Args":(InputTypes['updateUserUserFollowLink']);};}
