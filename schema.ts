...
/**All Root resolvers*/export type Root={"getUserRoleEnumPaginator":{"Type":(UserRole);"Args":(undefined);};"getUserPermissionEnumPaginator":{"Type":(UserPermission);"Args":(undefined);};"userGetCurrent":{"Type":(User);"Args":(undefined);};"userSyncCurrent":{"Type":(User);"Args":(undefined);};"userGetCurrentAvailablePermissions":{"Type":(Scalars['userPermission'])[];"Args":(undefined);};"userGet":{"Type":(User);"Args":(InputTypes['user']);};"userGetPaginator":{"Type":(UserPaginator);"Args":(InputTypes['userPaginatorInput']);};"userDelete":{"Type":(User);"Args":(InputTypes['user']);};"userCreate":{"Type":(User);"Args":(InputTypes['createUserArgs']);};"userUpdate":{"Type":(User);"Args":(InputTypes['userUpdate']);};"userGetStats":{"Type":(StatsResponse);"Args":(InputTypes['userStatsInput']);};"apiKeyGet":{"Type":(ApiKey);"Args":(InputTypes['apiKey']);};"apiKeyGetPaginator":{"Type":(ApiKeyPaginator);"Args":(InputTypes['apiKeyPaginatorInput']);};"apiKeyDelete":{"Type":(ApiKey);"Args":(InputTypes['apiKey']);};"apiKeyCreate":{"Type":(ApiKey);"Args":(InputTypes['createApiKeyArgs']);};"apiKeyUpdate":{"Type":(ApiKey);"Args":(InputTypes['apiKeyUpdate']);};"fileGet":{"Type":(File);"Args":(InputTypes['file']);};"fileGetPaginator":{"Type":(FilePaginator);"Args":(InputTypes['filePaginatorInput']);};"fileDelete":{"Type":(File);"Args":(InputTypes['file']);};"fileCreate":{"Type":(File);"Args":(InputTypes['createFileArgs']);};"fileUpdate":{"Type":(File);"Args":(InputTypes['fileUpdate']);};"fileGetStats":{"Type":(StatsResponse);"Args":(InputTypes['fileStatsInput']);};"executeGoogleApiRequest":{"Type":(Scalars['unknown'])|null;"Args":(InputTypes['executeGoogleApiRequestInput']);};"getRepositoryReleases":{"Type":(Scalars['unknown'])[];"Args":(InputTypes['getRepositoryReleases']);};"getRepositoryLatestVersion":{"Type":(Scalars['unknown'])|null;"Args":(undefined);};"userUserFollowLinkGet":{"Type":(UserUserFollowLink);"Args":(InputTypes['userUserFollowLink']);};"userUserFollowLinkGetPaginator":{"Type":(UserUserFollowLinkPaginator);"Args":(InputTypes['userUserFollowLinkPaginatorInput']);};"userUserFollowLinkDelete":{"Type":(UserUserFollowLink);"Args":(InputTypes['userUserFollowLink']);};"userUserFollowLinkCreate":{"Type":(UserUserFollowLink);"Args":(InputTypes['createUserUserFollowLinkArgs']);};"userUserFollowLinkUpdate":{"Type":(UserUserFollowLink);"Args":(InputTypes['userUserFollowLinkUpdate']);};}
