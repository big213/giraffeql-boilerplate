...
/**All Scalar values*/ export type Scalars = {
  ...
  /**Numeric value greater than equal to 0*/ positiveNumber: number;
  ...
  apiKeySortByKey: "id" | "createdAt" | "updatedAt";
  apiKeyGroupByKey: undefined;
  fileSortByKey: "id" | "createdAt" | "updatedAt";
...
/**All Input types*/ export type InputTypes = {
  ...
  user: { id?: Scalars["id"]; email?: Scalars["string"] };
  ...
  userSearchObject: { query: Scalars["string"] };
  userPaginator: {
    ...
    search?: InputTypes["userSearchObject"];
  };
  userStatsInput: {
    filterBy?: InputTypes["userFilterByObject"][];
    search?: InputTypes["userSearchObject"];
  ...
  createUser: {
    ...
    avatarUrl?: Scalars["imageUrl"] | null;
  ...
  apiKeySearchObject: { query: Scalars["string"] };
  apiKeyPaginator: {
    first?: Scalars["number"];
    last?: Scalars["number"];
    after?: Scalars["string"];
    ...
    search?: InputTypes["apiKeySearchObject"];
  };
  apiKeyStatsInput: {
    filterBy?: InputTypes["apiKeyFilterByObject"][];
    search?: InputTypes["apiKeySearchObject"];
  ...
  fileSearchObject: { query: Scalars["string"] };
  filePaginator: {
    first?: Scalars["number"];
    last?: Scalars["number"];
    after?: Scalars["string"];
    ...
    search?: InputTypes["fileSearchObject"];
  };
  fileStatsInput: {
    filterBy?: InputTypes["fileFilterByObject"][];
    search?: InputTypes["fileSearchObject"];
  ...
  executeVertexRequestInput: {
    query: Scalars["string"];
    url: Scalars["url"];
    data?: Scalars["unknown"] | null;
  };
...
/**All main types*/ export type MainTypes = {
  ...
  StatsResponse: { Typename: "StatsResponse"; Type: GetType<StatsResponse> };
};
...
/**User type*/ export type User = {
  ...
  avatarUrl: { Type: Scalars["imageUrl"] | null; Args: undefined };
  ...
  allowEmailNotifications: { Type: Scalars["boolean"]; Args: undefined };
...
/**File*/ export type File = {
  ...
  servingUrl: { Type: Scalars["url"]; Args: undefined };
  downloadUrl: { Type: Scalars["url"]; Args: undefined };
  signedUrl: { Type: Scalars["url"]; Args: undefined };
...
/**All Root resolvers*/ export type Root = {
  ...
  getUserStats: { Type: StatsResponse; Args: InputTypes["userStatsInput"] };
  ...
  getApiKeyStats: { Type: StatsResponse; Args: InputTypes["apiKeyStatsInput"] };
  ...
  getFileStats: { Type: StatsResponse; Args: InputTypes["fileStatsInput"] };
  ...
  executeVertexRequest: {
    Type: Scalars["unknown"] | null;
    Args: InputTypes["executeVertexRequestInput"];
  };
  ...
  getUserUserFollowLinkStats: {
    Type: StatsResponse;
    Args: InputTypes["userUserFollowLinkStatsInput"];
  };
