<template>
  <div v-if="viewDefinition?.viewRecordPageOptions">
          ...
          <v-col v-if="recordMode === 'minimized'" cols="12">
            <PreviewRecordChip :value="selectedItem">
              ...
              -->
                ...
                <v-btn icon small>
                  <v-icon @click="openViewRecordDialog()"
              ...
              >
                <template v-slot:toolbar>
                  <v-toolbar flat color="accent" dense>
                    ...
                    <v-btn v-if="true" icon @click="openEditDialog('share')">
  ...
  <v-container v-else fill-height>
    <v-layout align-center justify-center>
      <div>
        <span class="display-1 pl-2">{{
          viewDefinition ? 'View Not Available' : 'View Not Found'
        }}</span>
      </div>
    </v-layout>
  </v-container>
